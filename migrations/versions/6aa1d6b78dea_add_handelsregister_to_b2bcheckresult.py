"""Add handelsregister to B2BCheckResult

Revision ID: 6aa1d6b78dea
Revises: e053ad4fd5dc
Create Date: 2025-11-22 11:33:33.566248
...
revision = '6aa1d6b78dea'
down_revision = 'e053ad4fd5dc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('b2b_check_results', schema=None) as batch_op:
        batch_op.add_column(sa.Column('handelsregister', sa.String(length=64), nullable=True))
...
def downgrade():
    ...
    with op.batch_alter_table('b2b_check_results', schema=None) as batch_op:
        ...
        batch_op.drop_column('handelsregister')
